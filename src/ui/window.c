...
void _on_should_hide_internal_if_lid_closed_checkbox_toggled(GtkToggleButton *widget, gpointer data) {
	gboolean should_hide_internal_if_lid_closed = gtk_toggle_button_get_active(widget);
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(widget), should_hide_internal_if_lid_closed);
